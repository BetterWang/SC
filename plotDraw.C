...
void plotDraw(int sMB = 12, int sHM = 11)
{
	...
	trimGraph(gr2323MB , 125);
	trimGraph(gr2424MB , 125);
	trimGraph(gr2525MB , 125);
	trimGraph(gr2626MB , 125);
	trimGraph(gr3434MB , 125);
	trimGraph(gr3535MB , 125);
	trimGraph(gr3636MB , 125);
	trimGraph(gr4545MB , 125);
	trimGraph(gr4646MB , 125);
	trimGraph(gr5656MB , 125);

	trimGraph(gr2323HM , -125);
	trimGraph(gr2424HM , -125);
	trimGraph(gr2525HM , -125);
	trimGraph(gr2626HM , -125);
	trimGraph(gr3434HM , -125);
	trimGraph(gr3535HM , -125);
	trimGraph(gr3636HM , -125);
	trimGraph(gr4545HM , -125);
	trimGraph(gr4646HM , -125);
	trimGraph(gr5656HM , -125);
